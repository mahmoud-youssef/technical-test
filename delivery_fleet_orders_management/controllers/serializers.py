...
class Serializer(object):
    ...
    def build_flat_field(cls, rec, field_name):
        ...
        if field_type in ['one2many', 'many2many']:
            ...
            print(field_name)
            if field_name != "message_unread" and field_name != "message_unread_counter" and field_name != "message_needaction" \
                    and field_name != "message_needaction_counter" and field_name != "message_has_error" \
                    and field_name != "message_has_error_counter" and field_name != "message_has_sms_error" and field_name != "message_has_sms_error_counter":
                if rec[field_name]:
